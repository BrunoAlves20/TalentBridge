...
export const mockAIFeedback: AIFeedback[] = [
  { category: "Comunicação", score: 92, label: "Excelente" },
  { category: "Conhecimento Técnico", score: 88, label: "Muito Bom" },
  { category: "Clareza", score: 95, label: "Excepcional" },
];

export const aiInterviewQuestion =
  "Como você lidaria com um conflito de estado no React quando múltiplos componentes precisam compartilhar dados?";
